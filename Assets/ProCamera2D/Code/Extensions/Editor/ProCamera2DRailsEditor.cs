    ...
    public class ProCamera2DRailsEditor : Editor
    {
        ...
        void OnSceneGUI()
        {
            ...
            for (int i = 0; i < nodesCount; i++)
            {
                ...
                var fmh_304_34_638725313373646677 = Quaternion.identity; var newPos = Handles.FreeMoveHandle(
                                 oldPos,
                                 handleSize,
                                 pointSnap,
                ...
                if (deleteMode && nodesCount > 2)
                {
                    ...
                    if (Handles.Button(deleteButtonPos, Quaternion.identity, handleSize, handleSize, Handles.RectangleHandleCap))
                    {
